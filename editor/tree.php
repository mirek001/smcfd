...
<html xmlns="http://www.w3.org/1999/xhtml">
	...
	oryginalny link >>>	echo php_file_tree("../", "javascript:alert('You clicked on [link]');");
		...
		echo php_file_tree("../", "edit.php?file=[link]&action=1");
		//echo php_file_tree("../core/", "edit.php?file=[link]&action=1");
